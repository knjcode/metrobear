[めとろべあ (http://sr.metrobear.tokyo)](http://sr.metrobear.tokyo)
====
...
## アプリ紹介動画
[![めとろべあ](http://img.youtube.com/vi/5xLFb1zwu3o/0.jpg)](https://www.youtube.com/watch?v=5xLFb1zwu3o)
...
## ソーシャル連携
各種ソーシャルボタンについては忍者おまとめボタンを利用しています。  
Facebookのfacepileをページに下部に設置しています。
利用時は環境変数`TMSR_URL`にページのURLを指定する必要があります。
